...
if (process.platform == 'darwin') {
  ...
  //if (process.arch == 'x64')
    greenworks = require(`${FOLDER}/greenworks-osx64`);
  //else if (process.arch == 'ia32')
  //  greenworks = require(`${FOLDER}/greenworks-osx32`);
} else if (process.platform == 'win32') {
  if (process.arch == 'x64')
  //  greenworks = require( `${FOLDER}/greenworks-osx64` ); 
  greenworks = require(`${FOLDER}/greenworks-win64`);
  else if (process.arch == 'ia32')
    greenworks = require(`${FOLDER}/greenworks-win32`);
} else if (process.platform == 'linux') {
  if (process.arch == 'x64')
    greenworks = require(`${FOLDER}/greenworks-linux64`);
  else if (process.arch == 'ia32')
    greenworks = require(`${FOLDER}/greenworks-linux32`);
}
...
greenworks.init = function() {
  ...
  if (!this.isSteamRunning()){
    alert( "Steam initialization failed. Steam is not running. Try restart" )
...
global.module.exports = greenworks;
